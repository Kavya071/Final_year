...
import { signInWithGoogle, saveUserRole } from './firebaseAuth';
    ...
    try {
      ...
      setTimeout(() => {
        ...
        if (selectedRole === 'candidate') {
          ...
          // Navigate to interviewer dashboard (you can implement this later)
          console.log('Interviewer dashboard not implemented yet');
          if (onNavigate) {
            onNavigate('home');
          }
        }
